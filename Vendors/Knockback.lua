...
function KnockbackHandler.Apply(Model, Direction, Range, Height)
	...
	EnemyCharacter.PrimaryPart:ApplyImpulse(
		Direction * KnockbackHandler.CalculateMass(EnemyCharacter) * Range
			+ Vector3.new(
				0,
				KnockbackHandler.CalculateMass(EnemyCharacter) * Height,
				0
			)
	)
end
